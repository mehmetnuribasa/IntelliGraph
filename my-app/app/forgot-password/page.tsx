...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center p-4 sm:px-6 lg:px-8 pb-56">
        <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 sm:p-10 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            {message && (
              <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-green-600 dark:text-green-300 px-4 py-3 rounded-lg text-sm flex items-center gap-2" role="alert">
            ...
            <div className="text-center">
              <Link 
                href="/login" 
                className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 transition-colors flex items-center justify-center gap-2"
              >
