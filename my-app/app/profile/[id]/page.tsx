                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {isOwnProfile && (
                          <div className="flex items-center gap-2">
                            <Link
                              href={`/edit-project/${project.projectId || project.id}`}
                              className="px-3 py-1.5 text-sm font-medium text-blue-600 hover:text-white bg-blue-50 hover:bg-blue-600 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-600 dark:hover:text-white rounded-lg transition-colors flex items-center gap-1.5"
                              title="Edit project"
                            >
                            ...
                            <button
                              onClick={() => handleDeleteProject(project.projectId || project.id, project.title)}
                              className="px-3 py-1.5 text-sm font-medium text-red-600 hover:text-white bg-red-50 hover:bg-red-600 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-600 dark:hover:text-white rounded-lg transition-colors flex items-center gap-1.5"
                      ...
                      <div key={call.id} className="p-5 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl hover:shadow-md transition-shadow">
                        ...
                        {isOwnProfile && (
                          <div className="flex items-center justify-end gap-2 mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                            <Link
                              href={`/edit-call/${call.id}`}
                              className="px-3 py-1.5 text-sm font-medium text-purple-600 hover:text-white bg-purple-50 hover:bg-purple-600 dark:bg-purple-900/30 dark:text-purple-400 dark:hover:bg-purple-600 dark:hover:text-white rounded-lg transition-colors flex items-center gap-1.5"
